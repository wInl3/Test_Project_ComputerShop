                                            ...
                                            <c:if test="${not empty orders}">
                                                <c:forEach var="order" items="${orders}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="OrderBuildPC?service=warrantyAction&orderID=${order.orderID}" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <c:if test="${code.status == 3}">
                                                    <form action="OrderBuildPC" method="post" style="display: inline-block;">
                                                    ...
                                                    <form action="OrderBuildPC" method="post" style="display: inline-block; margin-left: 5px;">
                                                        <input type="hidden" name="service" value="warrantyAction" />
                                                        <input type="hidden" name="productCode" value="${code.productCode}" />
