                                            ...
                                            <c:if test="${not empty orders}">
                                                <c:forEach var="order" items="${orders}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="OrderBuildPCDetails?service=listItemComplete&orderID=${order.orderID}" 
                                                               class="btn btn-warning btn-sm">View</a>
                                                        </td>
                                                        <td>
                                                            <a href="OrderBuildPC?service=viewConsignee&orderID=${order.orderID}" 
                                                               class="btn btn-warning btn-sm">View</a>
                                                        </td>
                                                        <td>
                                                            <a href="OrderBuildPC?service=viewShipping&orderID=${order.orderID}" 
                                                               class="btn btn-warning btn-sm">View</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
